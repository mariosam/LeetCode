...
import { checkValid } from './CheckEveryRowColumnContainsNumbers.js'

TEST('Starting CheckEveryRowColumnContainsNumbers test...', (t) => {
    //Test 1
    let want = true
    let got = checkValid( [[1,2,3],[3,1,2],[2,3,1]] )
    t.assert( want === got, "Expect: true")
    //Test 2
    want = false
    got = checkValid( [[1,1,1],[1,2,3],[1,2,3]] )
